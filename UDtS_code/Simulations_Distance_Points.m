function [Satellite_Link_Farms,Distance_from_sub_point,Difference_from_GW_Slant_Range] = Simulations_Distance_Points(Earth_Radius,Orbit_Height,Grid,Subpoint);
