...
%     Distance_from_sub_point(WhichAngle) = sqrt((Subpoint(1,1)-Satellite_Link_Farms(WhichAngle,Subpoint,1))^2 + (Subpoint(1,2) - Satellite_Link_Farms(WhichAngle,Subpoint,2))^2);
%     
